...
<div class="sched-card">
    <form action="<?= base_url('admin/scheduling') ?>" method="post" id="doctor-scheduling-form">
        ...
        <div class="sched-grid">
            ...
            <div>
                <div class="sched-label">Shift</div>
                <select name="shift_name" class="sched-select">
        ...
        <div style="margin-top:12px;display:flex;justify-content:flex-end;gap:8px;">
            <button type="button" onclick="clearForm()" class="sched-input" style="width:auto;border-radius:999px;border:1px solid #d1d5db;background:#ffffff;cursor:pointer;">Clear</button>
...
<script>
    ...
    (function() {
        ...
        // Ensure day inputs are synced before form submission
        form.addEventListener('submit', function(e) {
            syncDayInputs();
            // Validate that at least one day is selected
            const selectedDays = form.querySelectorAll('input[name="days[]"]');
